...
const TILE_SIZE = 16
const MOCK_WIDTH = TILE_SIZE * 124 /* 1984 */
const MOCK_HEIGHT = TILE_SIZE * 68 /* 1088 */
...
export class PuertoValerisScene {
	...
	checkNPCInteraction() {
		...
		for (const npc of this.npcs) {
			...
			let mentorTalk = npc.id === 1

			// TODO: EL MENTOR VUELVE A REPETIR EL PRIMER DIALOGO
			// no permite al jugador continuar
