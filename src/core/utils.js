...
export const checkCollisions = (ob1, ob2) => {
  const box1 = ob1.hitbox ? ob1.hitbox : ob1
  const box2 = ob2.hitbox ? ob2.hitbox : ob2

  if (!isColliding(box1, box2)) return null
...
export const isColliding = (ob1, ob2) => {
  const box1 = ob1.hitbox
  const box2 = ob2.hitbox ? ob2.hitbox : ob2
